...
import { getMedicationReminders, getUserUpcomingReminders, markReminderSent, sendReminderNotification, generateAllReminders } from "../controllers/reminderController.js";
const router = Router();
