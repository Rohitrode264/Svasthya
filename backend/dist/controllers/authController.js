...
export const initiateSignup = async (req, res) => {
    try {
        ...
        await sendMail(email, "Verify your Svasthya account", `<p>Your verification code is <strong>${code}</strong>. It expires in 15 minutes.</p>`, "Account Verification");
...
export const initiatePasswordReset = async (req, res) => {
    try {
        ...
        await sendMail(email, "Reset your Svasthya password", `<p>Your password reset code is <strong>${code}</strong>. It expires in 15 minutes.</p>`, "Password Reset");
        return res.status(200).json({ message: "If the email exists, a code has been sent" });
    }
    catch (err) {
        console.error(err);
