...
export const getUserUpcomingReminders = async (req: Request, res: Response) => {
  try {
...
export const sendReminderNotification = async (req: Request, res: Response) => {
  try {
    const { reminderId } = req.params;
...
export const generateAllReminders = async (req: Request, res: Response) => {
  try {
